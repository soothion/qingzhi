<?php require_once('E:\wamp\www\qingzhi\include\template_lite\plugins\modifier.date_format.php'); $this->register_modifier("date_format", "tpl_modifier_date_format",false);  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2014-09-03 11:18 ?D1ú±ê×?ê±?? */ ?>
...
unset($_templatelite_tpl_vars);
 ?>
	...
	<table width="96%" border="0" cellspacing="0" cellpadding="10" class="link_lan" style="margin:0 auto;">
	 <?php if (count((array)$this->_vars['pms'])): foreach ((array)$this->_vars['pms'] as $this->_vars['list']): ?>
  <tr>
    <td width="80" align="center" class="us_list" style="padding:20px 0;">
