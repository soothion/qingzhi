<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2013-10-06 16:16 中国标准时间 */  $_templatelite_tpl_vars = $this->_vars;
...
" maxlength="80"/></td>
            ...
            <tr>
      <td align="right">幻灯片一：</td>
      <td><input name="slide1_url" type="text"  class="input_text_400" value="<?php echo $this->_vars['config']['slide1_url']; ?>
" maxlength="80"/><input name="slide1_photo" type="file"  style="width:300px; font-size:12px; padding:3px;" onKeyDown="alert('请点击右侧“浏览”选择您电脑上的图片！');return false"/></td>
    </tr>
                <tr>
      <td align="right">幻灯片二：</td>
      <td><input name="slide2_url" type="text"  class="input_text_400"  value="<?php echo $this->_vars['config']['slide2_url']; ?>
" maxlength="80"/><input name="slide2_photo" type="file"  style="width:300px; font-size:12px; padding:3px;" onKeyDown="alert('请点击右侧“浏览”选择您电脑上的图片！');return false"/></td>
    </tr>
                <tr>
      <td align="right">幻灯片三：</td>
      <td><input name="slide3_url" type="text"  class="input_text_400"  value="<?php echo $this->_vars['config']['slide3_url']; ?>
" maxlength="80"/><input name="slide3_photo" type="file"  style="width:300px; font-size:12px; padding:3px;" onKeyDown="alert('请点击右侧“浏览”选择您电脑上的图片！');return false"/></td>
    </tr>
                <tr>
      <td align="right">幻灯片四：</td>
      <td><input name="slide4_url" type="text"  class="input_text_400"  value="<?php echo $this->_vars['config']['slide4_url']; ?>
" maxlength="80"/><input name="slide4_photo" type="file"  style="width:300px; font-size:12px; padding:3px;" onKeyDown="alert('请点击右侧“浏览”选择您电脑上的图片！');return false"/></td>
    </tr>
                <tr>
      <td align="right">幻灯片五：</td>
      <td><input name="slide5_url" type="text"  class="input_text_400" value="<?php echo $this->_vars['config']['slide5_url']; ?>
" maxlength="80"/><input name="slide5_photo" type="file"  style="width:300px; font-size:12px; padding:3px;" onKeyDown="alert('请点击右侧“浏览”选择您电脑上的图片！');return false"/></td>
    </tr>
