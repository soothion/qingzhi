...
"/>
	 <?php if ($this->_vars['list']['m_type'] == "0"): ?><span style="color:#FF6600">等待发送</span><?php endif; ?>
	 <?php if ($this->_vars['list']['m_type'] == "1"): ?><span style="color: #009900">发送成功</span><?php endif; ?>
	 <?php if ($this->_vars['list']['m_type'] == "2"): ?><span style="color: #666666">发送失败</span><?php endif; ?>
	  </td>
	  <td  class="admin_list">
...
" /></div>
			    <div class="selbox">
					<input name="key_type_cn"  id="key_type_cn" type="text" value="<?php echo $this->_run_modifier($_GET['key_type_cn'], 'default', 'plugin', 1, "邮件主题"); ?>
" readonly="true"/>
						<div>
