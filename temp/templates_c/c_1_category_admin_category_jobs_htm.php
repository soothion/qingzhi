<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2013-08-26 20:20 中国标准时间 */  $_templatelite_tpl_vars = $this->_vars;
...
$(document).ready(function()
{
	...
	function MakeCat(pid)
	{
		...
		$.get("admin_ajax.php", {"act":"get_cat_jobs","tstime":tsTimeStamp,"pid":pid},
				...
				{	
				 ...
				 var html="";
					...
					html+="<input name=\"save_id[]\" type=\"hidden\" value=\""+val[0]+"\" />";
			 		...
			 		html+="<a href=\"?act=edit_jobs_category&id="+val[0]+"\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;";	
					html+="<a onclick=\"return confirm('你确定要删除吗？')\" href=\"?act=del_jobs_category&id="+val[0]+"&<?php echo $this->_vars['urltoken']; ?>
\">删除</a>";
					html+="</td>";	
					html+="</tr>";
					i++;
...
" class="input_text_50"/>
      ...
      <td class="admin_list">
	  <a href="?act=add_category_jobs&parentid=<?php echo $this->_vars['list']['id']; ?>
">此类下加子类</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="?act=edit_jobs_category&id=<?php echo $this->_vars['list']['id']; ?>
">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;

			  <a onclick="return confirm('你确定要删除吗？')" href="?act=del_jobs_category&id=<?php echo $this->_vars['list']['id']; ?>
...
<tr>
        ...
        <input name="ButADD" type="button" class="admin_submit" id="ButADD" value="添加分类"  onclick="window.location='?act=add_category_jobs'"/>
