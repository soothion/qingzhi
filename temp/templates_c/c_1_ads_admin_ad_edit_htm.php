<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2013-08-17 18:37 中国标准时间 */  $_templatelite_tpl_vars = $this->_vars;
...
"  <?php if ($this->_vars['li']['id'] == $this->_vars['ad']['category_id']): ?>selected="selected"<?php endif; ?>><?php echo $this->_vars['li']['categoryname']; ?>
                 ...
                 <option value="1,2,QS_indexfocus" >首页图片轮番广告</option>
                </select>
...
"/>                     <span class="admin_note">如:http://www.qingzhi.org</span></td>
                </tr>
                <tr>
...
"/>               <span class="admin_note">如：/images/123.swf 或 http://www.qingzhi.org/123.swf</span></td>
                </tr>
                <tr>
