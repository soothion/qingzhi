	 ...
	 {		
			...
			if (inserttable(table('personal_jobs_apply'),$addarr))
			{
					...
					switch ($jobs['nature'])
						{
						case 62:
						  $operator_type='resume_quanzhi';
						  break;  
						case 63:
						  $operator_type='resume_jianxi';
						  break;
						case 64:
						  $operator_type='resume_jianzhi';
						  break;
						}
					if ($points[$operator_type]['value']>0)
					{	
						...
						report_deal($_SESSION['uid'],$points[$operator_type]['type'],$points[$operator_type]['value']);
						$operator=$points[$operator_type]['type']=="1"?"+":"-";
						write_memberslog($_SESSION['uid'],2,9001,$_SESSION['username'],"投递简历,({$operator}{$points[$operator_type]['value']})");
					}
